...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class dev.case.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class dev.case.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class dev.case.api.** {
    <init>(...);
