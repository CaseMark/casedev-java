...
import com.router.api.services.async.format.V1ServiceAsync
import java.util.function.Consumer

interface FormatServiceAsync {
    ...
    /**
     * A view of [FormatServiceAsync] that provides access to raw HTTP responses for each method.
     */
