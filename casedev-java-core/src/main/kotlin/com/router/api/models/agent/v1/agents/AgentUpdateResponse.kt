...
private constructor(
     ...
     * ```java
     * MyClass myObject = agentUpdateResponse.sandbox().convert(MyClass.class);
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agentUpdateResponse: AgentUpdateResponse) = apply {
            ...
            description = agentUpdateResponse.description
            disabledTools = agentUpdateResponse.disabledTools.map { it.toMutableList() }
            enabledTools = agentUpdateResponse.enabledTools.map { it.toMutableList() }
            instructions = agentUpdateResponse.instructions
            isActive = agentUpdateResponse.isActive
            model = agentUpdateResponse.model
