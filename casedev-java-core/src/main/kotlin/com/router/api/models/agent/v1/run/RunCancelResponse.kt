...
private constructor(
    ...
    ) : this(id, message, status, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(runCancelResponse: RunCancelResponse) = apply {
            ...
            message = runCancelResponse.message
        ...
        fun build(): RunCancelResponse =
            RunCancelResponse(id, message, status, additionalProperties.toMutableMap())
    }
    ...
    private val hashCode: Int by lazy { Objects.hash(id, message, status, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "RunCancelResponse{id=$id, message=$message, status=$status, additionalProperties=$additionalProperties}"
}
