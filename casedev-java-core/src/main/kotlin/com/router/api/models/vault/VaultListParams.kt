...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): VaultListParams =
            VaultListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "VaultListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
