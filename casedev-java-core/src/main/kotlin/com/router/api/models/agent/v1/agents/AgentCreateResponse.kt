...
package com.router.api.models.agent.v1.agents
...
private constructor(
     ...
     * ```java
     * MyClass myObject = agentCreateResponse.sandbox().convert(MyClass.class);
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agentCreateResponse: AgentCreateResponse) = apply {
            id = agentCreateResponse.id
            createdAt = agentCreateResponse.createdAt
            description = agentCreateResponse.description
            disabledTools = agentCreateResponse.disabledTools.map { it.toMutableList() }
            enabledTools = agentCreateResponse.enabledTools.map { it.toMutableList() }
            instructions = agentCreateResponse.instructions
            model = agentCreateResponse.model
            name = agentCreateResponse.name
            sandbox = agentCreateResponse.sandbox
            updatedAt = agentCreateResponse.updatedAt
            vaultIds = agentCreateResponse.vaultIds.map { it.toMutableList() }
    ...
    override fun toString() =
        "AgentCreateResponse{id=$id, createdAt=$createdAt, description=$description, disabledTools=$disabledTools, enabledTools=$enabledTools, instructions=$instructions, model=$model, name=$name, sandbox=$sandbox, updatedAt=$updatedAt, vaultIds=$vaultIds, additionalProperties=$additionalProperties}"
}
