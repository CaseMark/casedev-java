...
import com.router.api.core.BaseDeserializer
import com.router.api.core.BaseSerializer
...
import com.router.api.core.allMaxBy
import com.router.api.core.checkRequired
import com.router.api.core.getOrThrow
...
/**
 * Create vector embeddings from text using OpenAI-compatible models. Perfect for semantic search,
 * document similarity, and building RAG systems for legal documents.
 */
...
private constructor(
    ...
    /** A builder for [V1CreateEmbeddingParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreateEmbeddingParams: V1CreateEmbeddingParams) = apply {
            body = v1CreateEmbeddingParams.body.toBuilder()
            additionalHeaders = v1CreateEmbeddingParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CreateEmbeddingParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [V1CreateEmbeddingParams].
         *
         ...
         */
        fun build(): V1CreateEmbeddingParams =
    ...
    private constructor(
        ...
        interface Visitor<out T> {
            ...
            fun unknown(json: JsonValue?): T {
                throw CasedevInvalidDataException("Unknown Input: $json")
            }
        }
    ...
    class EncodingFormat @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        fun known(): Known =
            when (this) {
                FLOAT -> Known.FLOAT
                BASE64 -> Known.BASE64
                else -> throw CasedevInvalidDataException("Unknown EncodingFormat: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V1CreateEmbeddingParams &&
            body == other.body &&
    ...
    override fun toString() =
        "V1CreateEmbeddingParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
