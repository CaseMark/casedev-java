...
class GraphragServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun getStats(params: GraphragGetStatsParams, requestOptions: RequestOptions) {
        // get /vault/{id}/graphrag/stats
        withRawResponse().getStats(params, requestOptions)
    }

    override fun init(params: GraphragInitParams, requestOptions: RequestOptions) {
        // post /vault/{id}/graphrag/init
        withRawResponse().init(params, requestOptions)
    }
