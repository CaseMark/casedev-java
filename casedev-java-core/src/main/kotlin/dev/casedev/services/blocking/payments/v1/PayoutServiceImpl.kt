...
class PayoutServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun create(params: PayoutCreateParams, requestOptions: RequestOptions) {
        // post /payments/v1/payouts
        withRawResponse().create(params, requestOptions)
    }

    override fun retrieve(params: PayoutRetrieveParams, requestOptions: RequestOptions) {
        // get /payments/v1/payouts/{id}
        withRawResponse().retrieve(params, requestOptions)
    }

    override fun list(params: PayoutListParams, requestOptions: RequestOptions) {
        // get /payments/v1/payouts
        withRawResponse().list(params, requestOptions)
    }

    override fun cancel(params: PayoutCancelParams, requestOptions: RequestOptions) {
        // post /payments/v1/payouts/{id}/cancel
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("payments", "v1", "payouts")
        ...
        override fun retrieve(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("payments", "v1", "payouts", params._pathParam(0))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
            val response = clientOptions.httpClient.execute(request, requestOptions)
        ...
        override fun list(params: PayoutListParams, requestOptions: RequestOptions): HttpResponse {
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.GET)
                    .baseUrl(clientOptions.baseUrl())
        ...
        override fun cancel(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("payments", "v1", "payouts", params._pathParam(0), "cancel")
