...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** CSS styles for the template */
        fun styles(styles: JsonValue) = apply { body.styles(styles) }
    ...
    private constructor(
        ...
        ) : this(content, name, type, description, styles, tags, variables, mutableMapOf())
        ...
        override fun toString() =
            "Body{content=$content, name=$name, type=$type, description=$description, styles=$styles, tags=$tags, variables=$variables, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CAPTION = of("caption")

            @JvmField val SIGNATURE = of("signature")

            @JvmField val LETTERHEAD = of("letterhead")
