...
package dev.casedev.models.format.v1.templates
...
private constructor(
    ...
    ) : this(id, createdAt, name, type, variables, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateCreateResponse: TemplateCreateResponse) = apply {
            id = templateCreateResponse.id
            createdAt = templateCreateResponse.createdAt
            name = templateCreateResponse.name
            type = templateCreateResponse.type
            variables = templateCreateResponse.variables.map { it.toMutableList() }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, name, type, variables, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "TemplateCreateResponse{id=$id, createdAt=$createdAt, name=$name, type=$type, variables=$variables, additionalProperties=$additionalProperties}"
}
