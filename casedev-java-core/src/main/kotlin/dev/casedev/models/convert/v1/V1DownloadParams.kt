...
/**
 * Download the converted M4A audio file from a completed FTR conversion job. The file is streamed
 * directly to the client with appropriate headers for audio playback or download.
 */
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1DownloadParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): V1DownloadParams =
            V1DownloadParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "V1DownloadParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
