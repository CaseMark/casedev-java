...
private constructor(
    ...
    ) : this(jobId, message, status, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v1ProcessResponse: V1ProcessResponse) = apply {
            jobId = v1ProcessResponse.jobId
            message = v1ProcessResponse.message
        ...
        fun build(): V1ProcessResponse =
            V1ProcessResponse(jobId, message, status, additionalProperties.toMutableMap())
    }
    ...
    private val hashCode: Int by lazy { Objects.hash(jobId, message, status, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "V1ProcessResponse{jobId=$jobId, message=$message, status=$status, additionalProperties=$additionalProperties}"
}
