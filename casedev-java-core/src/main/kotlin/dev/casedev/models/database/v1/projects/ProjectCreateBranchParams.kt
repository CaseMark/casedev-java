 ...
 * provide instant point-in-time clones of your database for isolated development, staging, testing,
 * or feature work. Perfect for testing schema changes, running migrations safely, or creating
...
private constructor(
     ...
     */
    fun parentBranchId(): Optional<String> = body.parentBranchId()
     ...
     */
    fun _parentBranchId(): JsonField<String> = body._parentBranchId()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProjectCreateBranchParams].
         *
    ...
    /** A builder for [ProjectCreateBranchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(projectCreateBranchParams: ProjectCreateBranchParams) = apply {
            id = projectCreateBranchParams.id
            body = projectCreateBranchParams.body.toBuilder()
            additionalHeaders = projectCreateBranchParams.additionalHeaders.toBuilder()
            additionalQueryParams = projectCreateBranchParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Parent branch ID to clone from (defaults to main branch) */
        fun parentBranchId(parentBranchId: String) = apply { body.parentBranchId(parentBranchId) }
        ...
        fun parentBranchId(parentBranchId: JsonField<String>) = apply {
            body.parentBranchId(parentBranchId)
        }
         ...
         */
        fun build(): ProjectCreateBranchParams =
    ...
    private constructor(
        ...
        ) : this(name, parentBranchId, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            fun parentBranchId(parentBranchId: String) =
                parentBranchId(JsonField.of(parentBranchId))
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, parentBranchId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, parentBranchId=$parentBranchId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProjectCreateBranchParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ProjectCreateBranchParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
