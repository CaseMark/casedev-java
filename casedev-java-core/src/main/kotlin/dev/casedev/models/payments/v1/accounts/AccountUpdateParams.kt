...
private constructor(
     ...
     * ```java
     * MyClass myObject = accountUpdateParams.metadata().convert(MyClass.class);
     * ```
     */
    ...
    private constructor(
        ...
        ) : this(isActive, metadata, name, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(isActive, metadata, name, additionalProperties.toMutableMap())
        }
        ...
        internal fun validity(): Int =
            (if (isActive.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy {
            Objects.hash(isActive, metadata, name, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{isActive=$isActive, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
    }
