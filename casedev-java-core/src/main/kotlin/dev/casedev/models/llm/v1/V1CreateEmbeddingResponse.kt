...
private constructor(
    ...
    /** A builder for [V1CreateEmbeddingResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreateEmbeddingResponse: V1CreateEmbeddingResponse) = apply {
            data = v1CreateEmbeddingResponse.data.map { it.toMutableList() }
            model = v1CreateEmbeddingResponse.model
            object_ = v1CreateEmbeddingResponse.object_
            usage = v1CreateEmbeddingResponse.usage
            additionalProperties = v1CreateEmbeddingResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): V1CreateEmbeddingResponse =
    ...
    fun validate(): V1CreateEmbeddingResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Usage =
                Usage(promptTokens, totalTokens, additionalProperties.toMutableMap())
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V1CreateEmbeddingResponse &&
            data == other.data &&
            model == other.model &&
            object_ == other.object_ &&
            usage == other.usage &&
    ...
    override fun toString() =
        "V1CreateEmbeddingResponse{data=$data, model=$model, object_=$object_, usage=$usage, additionalProperties=$additionalProperties}"
}
