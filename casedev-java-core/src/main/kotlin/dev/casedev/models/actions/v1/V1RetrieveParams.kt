...
/**
 * Retrieve a specific action definition by ID. Actions are reusable workflow components that can
 * perform tasks like document analysis, data extraction, or API integrations. Only actions
