...
/**
 * Initiate a multipart upload for large files (>5GB). Returns an uploadId and object metadata. Use
 * part URLs endpoint to upload parts and complete endpoint to finalize.
 */
class MultipartInitParams
private constructor(
     ...
     * ```java
     * MyClass myObject = multipartInitParams.metadata().convert(MyClass.class);
     * ```
     */
     ...
     *   server responded with an unexpected value).
     */
    fun partSizeBytes(): Optional<Long> = body.partSizeBytes()
     ...
     */
    fun _partSizeBytes(): JsonField<Long> = body._partSizeBytes()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultipartInitParams].
         *
    ...
    /** A builder for [MultipartInitParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(multipartInitParams: MultipartInitParams) = apply {
            id = multipartInitParams.id
            body = multipartInitParams.body.toBuilder()
            additionalHeaders = multipartInitParams.additionalHeaders.toBuilder()
            additionalQueryParams = multipartInitParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Multipart part size in bytes (min 5MB). Defaults to 64MB. */
        fun partSizeBytes(partSizeBytes: Long) = apply { body.partSizeBytes(partSizeBytes) }
        ...
        fun partSizeBytes(partSizeBytes: JsonField<Long>) = apply {
            body.partSizeBytes(partSizeBytes)
        }
        ...
        /**
         * Returns an immutable instance of [MultipartInitParams].
         *
    ...
    private constructor(
         ...
         * Returns the raw JSON value of [partSizeBytes].
         *
         * Unlike [partSizeBytes], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("partSizeBytes")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.partSizeBytes] to an arbitrary JSON value.
             *
             * You should usually call [Builder.partSizeBytes] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun partSizeBytes(partSizeBytes: JsonField<Long>) = apply {
        ...
        override fun toString() =
            "Body{contentType=$contentType, filename=$filename, sizeBytes=$sizeBytes, autoIndex=$autoIndex, metadata=$metadata, partSizeBytes=$partSizeBytes, path=$path, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MultipartInitParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "MultipartInitParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
