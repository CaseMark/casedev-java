...
/**
 * Retrieve all objects stored in a specific vault, including document metadata, ingestion status,
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ObjectListParams =
            ObjectListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObjectListParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ObjectListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
