...
private constructor(
    ...
    private constructor(
        ...
        ) : this(objectId, parts, sizeBytes, uploadId, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(objectId, parts, sizeBytes, uploadId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{objectId=$objectId, parts=$parts, sizeBytes=$sizeBytes, uploadId=$uploadId, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        ) : this(etag, partNumber, mutableMapOf())

        /**
         * @throws CasedevInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun etag(): String = etag.getRequired("etag")
        ...
        class Builder internal constructor() {
            ...
            private var etag: JsonField<String>? = null
             ...
             *
             * You should usually call [Builder.etag] with a well-typed [String] value instead. This
        ...
        private val hashCode: Int by lazy { Objects.hash(etag, partNumber, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Part{etag=$etag, partNumber=$partNumber, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "MultipartCompleteParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
