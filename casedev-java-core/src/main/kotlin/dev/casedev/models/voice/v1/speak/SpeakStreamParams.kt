...
/**
 * Convert text to speech using ElevenLabs AI voices with streaming for real-time playback. Returns
 * audio data as an MP3 stream for immediate playback with minimal latency. Perfect for legal
 * document narration, client presentations, or accessibility features.
 */
class SpeakStreamParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SpeakStreamParams].
         *
    ...
    /** A builder for [SpeakStreamParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(speakStreamParams: SpeakStreamParams) = apply {
            body = speakStreamParams.body.toBuilder()
            additionalHeaders = speakStreamParams.additionalHeaders.toBuilder()
            additionalQueryParams = speakStreamParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SpeakStreamParams].
         *
    ...
    class ModelId @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val ELEVEN_MULTILINGUAL_V1 = of("eleven_multilingual_v1")
        ...
        fun value(): Value =
            when (this) {
                ...
                ELEVEN_MULTILINGUAL_V1 -> Value.ELEVEN_MULTILINGUAL_V1
        ...
        fun known(): Known =
            when (this) {
                ...
                ELEVEN_MULTILINGUAL_V1 -> Known.ELEVEN_MULTILINGUAL_V1
    ...
    class OutputFormat @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val MP3_22050_32 = of("mp3_22050_32")
        ...
        fun value(): Value =
            when (this) {
                ...
                MP3_22050_32 -> Value.MP3_22050_32
        ...
        fun known(): Known =
            when (this) {
                ...
                MP3_22050_32 -> Known.MP3_22050_32
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SpeakStreamParams &&
            body == other.body &&
    ...
    override fun toString() =
        "SpeakStreamParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
