...
private constructor(
    ...
    private val deleteFromHosting: Boolean?,
    ...
    class Builder internal constructor() {
        ...
        private var deleteFromHosting: Boolean? = null
        ...
        internal fun from(projectDeleteParams: ProjectDeleteParams) = apply {
            id = projectDeleteParams.id
            deleteFromHosting = projectDeleteParams.deleteFromHosting
        ...
        /**
         * Alias for [Builder.deleteFromHosting].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun deleteFromHosting(deleteFromHosting: Boolean) =
            deleteFromHosting(deleteFromHosting as Boolean?)

        /** Alias for calling [Builder.deleteFromHosting] with `deleteFromHosting.orElse(null)`. */
        fun deleteFromHosting(deleteFromHosting: Optional<Boolean>) =
            deleteFromHosting(deleteFromHosting.getOrNull())
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                deleteFromHosting?.let { put("deleteFromHosting", it.toString()) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProjectDeleteParams &&
            id == other.id &&
            deleteFromHosting == other.deleteFromHosting &&
    ...
    override fun toString() =
        "ProjectDeleteParams{id=$id, deleteFromHosting=$deleteFromHosting, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
