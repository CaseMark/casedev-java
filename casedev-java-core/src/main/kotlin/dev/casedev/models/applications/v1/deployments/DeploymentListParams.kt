...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(deploymentListParams: DeploymentListParams) = apply {
            projectId = deploymentListParams.projectId
            limit = deploymentListParams.limit
            state = deploymentListParams.state
            target = deploymentListParams.target
    ...
    override fun hashCode(): Int =
        Objects.hash(projectId, limit, state, target, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "DeploymentListParams{projectId=$projectId, limit=$limit, state=$state, target=$target, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
