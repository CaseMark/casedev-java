...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeploymentCancelParams].
         *
    ...
    /** A builder for [DeploymentCancelParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(deploymentCancelParams: DeploymentCancelParams) = apply {
            id = deploymentCancelParams.id
            body = deploymentCancelParams.body.toBuilder()
            additionalHeaders = deploymentCancelParams.additionalHeaders.toBuilder()
            additionalQueryParams = deploymentCancelParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DeploymentCancelParams].
         *
         ...
         */
        fun build(): DeploymentCancelParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeploymentCancelParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "DeploymentCancelParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
