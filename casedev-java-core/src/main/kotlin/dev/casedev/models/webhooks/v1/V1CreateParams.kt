 ...
 * workspace. Webhooks enable automated workflows by sending HTTP POST requests to your specified
 * URL when events occur.
 *
 * **Security**: Webhooks are signed with HMAC-SHA256 using the provided secret. The signature is
 * included in the `X-Case-Signature` header.
 *
 * **Available Events**:
...
private constructor(
    ...
    private constructor(
        ...
        ) : this(events, url, description, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(events, url, description, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{events=$events, url=$url, description=$description, additionalProperties=$additionalProperties}"
    }
