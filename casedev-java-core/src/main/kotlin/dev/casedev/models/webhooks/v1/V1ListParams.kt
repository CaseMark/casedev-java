...
/**
 * Retrieve all webhook endpoints configured for your organization. Webhooks allow you to receive
 * real-time notifications when events occur in your Case.dev workspace, such as document processing
 * completion, OCR results, or workflow status changes.
 */
class V1ListParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): V1ListParams =
            V1ListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "V1ListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
