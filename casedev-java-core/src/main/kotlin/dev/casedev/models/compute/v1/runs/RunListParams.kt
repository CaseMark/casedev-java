...
/**
 * Retrieve a list of recent compute runs for your organization. Filter by environment or function,
 * and limit the number of results returned. Useful for monitoring serverless function executions
...
private constructor(
    ...
    fun function(): Optional<String> = Optional.ofNullable(function)
    ...
    class Builder internal constructor() {
        ...
        internal fun from(runListParams: RunListParams) = apply {
            env = runListParams.env
            function = runListParams.function
        ...
        /** Alias for calling [Builder.function] with `function.orElse(null)`. */
        fun function(function: Optional<String>) = function(function.getOrNull())
    ...
    override fun hashCode(): Int =
        Objects.hash(env, function, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "RunListParams{env=$env, function=$function, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
