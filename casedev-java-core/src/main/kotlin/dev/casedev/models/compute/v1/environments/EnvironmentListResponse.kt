...
private constructor(
    private val environments: JsonField<List<Environment>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        environments: JsonField<List<Environment>> = JsonMissing.of()
    ) : this(environments, mutableMapOf())

    /**
     * @throws CasedevInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun environments(): Optional<List<Environment>> = environments.getOptional("environments")
    ...
    @JsonProperty("environments")
    @ExcludeMissing
    fun _environments(): JsonField<List<Environment>> = environments
    ...
    /** A builder for [EnvironmentListResponse]. */
    class Builder internal constructor() {

        private var environments: JsonField<MutableList<Environment>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(environmentListResponse: EnvironmentListResponse) = apply {
            environments = environmentListResponse.environments.map { it.toMutableList() }
            additionalProperties = environmentListResponse.additionalProperties.toMutableMap()
        }

        fun environments(environments: List<Environment>) = environments(JsonField.of(environments))

        /**
         * Sets [Builder.environments] to an arbitrary JSON value.
         *
         * You should usually call [Builder.environments] with a well-typed `List<Environment>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun environments(environments: JsonField<List<Environment>>) = apply {
            this.environments = environments.map { it.toMutableList() }
        }

        /**
         * Adds a single [Environment] to [environments].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addEnvironment(environment: Environment) = apply {
            environments =
                (environments ?: JsonField.of(mutableListOf())).also {
                    checkKnown("environments", it).add(environment)
                }
        }
        ...
        /**
         * Returns an immutable instance of [EnvironmentListResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EnvironmentListResponse =
            EnvironmentListResponse(
                (environments ?: JsonMissing.of()).map { it.toImmutable() },
    ...
    fun validate(): EnvironmentListResponse = apply {
        if (validated) {
            return@apply
        }

        environments().ifPresent { it.forEach { it.validate() } }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (environments.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    private constructor(
        ...
        ) : this(id, createdAt, domain, isDefault, name, slug, status, updatedAt, mutableMapOf())
        ...
        override fun toString() =
            "Environment{id=$id, createdAt=$createdAt, domain=$domain, isDefault=$isDefault, name=$name, slug=$slug, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnvironmentListResponse &&
            environments == other.environments &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(environments, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "EnvironmentListResponse{environments=$environments, additionalProperties=$additionalProperties}"
}
