...
/**
 * Retrieve all compute environments for your organization. Environments provide isolated execution
 * contexts for running code and workflows.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): EnvironmentListParams =
            EnvironmentListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "EnvironmentListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
