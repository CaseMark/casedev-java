...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{name=$name, description=$description, edges=$edges, nodes=$nodes, triggerConfig=$triggerConfig, triggerType=$triggerType, visibility=$visibility, additionalProperties=$additionalProperties}"
    }
