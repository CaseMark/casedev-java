...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1DeployParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v1DeployParams: V1DeployParams) = apply {
            ...
            additionalBodyProperties = v1DeployParams.additionalBodyProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "V1DeployParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
