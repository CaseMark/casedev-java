...
private constructor(
    ...
    ) : this(id, name, updatedAt, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v1UpdateResponse: V1UpdateResponse) = apply {
            id = v1UpdateResponse.id
            name = v1UpdateResponse.name
            updatedAt = v1UpdateResponse.updatedAt
        ...
        fun build(): V1UpdateResponse =
            V1UpdateResponse(id, name, updatedAt, additionalProperties.toMutableMap())
    }
    ...
    private val hashCode: Int by lazy { Objects.hash(id, name, updatedAt, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "V1UpdateResponse{id=$id, name=$name, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
