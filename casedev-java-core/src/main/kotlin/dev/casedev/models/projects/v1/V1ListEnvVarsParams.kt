...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1ListEnvVarsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [V1ListEnvVarsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [V1ListEnvVarsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ListEnvVarsParams: V1ListEnvVarsParams) = apply {
            id = v1ListEnvVarsParams.id
            environment = v1ListEnvVarsParams.environment
            additionalHeaders = v1ListEnvVarsParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ListEnvVarsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [V1ListEnvVarsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): V1ListEnvVarsParams =
            V1ListEnvVarsParams(
                id,
                environment,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V1ListEnvVarsParams &&
            id == other.id &&
    ...
    override fun hashCode(): Int =
        Objects.hash(id, environment, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "V1ListEnvVarsParams{id=$id, environment=$environment, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
