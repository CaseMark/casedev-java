 ...
 * embeddings. For supported file types (PDF, DOCX, TXT, RTF, XML, ZIP, audio, video), processing
 * happens asynchronously. ZIP archives are unpacked recursively up to 5 levels, and each extracted
 * file is created as an independent vault object and ingested via the normal pipeline. For
