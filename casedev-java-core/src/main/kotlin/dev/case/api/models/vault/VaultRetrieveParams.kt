...
/**
 * Retrieve detailed information about a specific vault, including storage configuration, chunking
 * strategy, and usage statistics. Returns vault metadata, bucket information, and vector storage
 * details.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): VaultRetrieveParams =
            VaultRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "VaultRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
