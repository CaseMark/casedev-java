...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1FindParams: V1FindParams) = apply {
            body = v1FindParams.body.toBuilder()
            additionalHeaders = v1FindParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1FindParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [V1FindParams].
         *
         ...
         */
        fun build(): V1FindParams =
            V1FindParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    private constructor(
        ...
        ) : this(query, jurisdiction, numResults, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(query, jurisdiction, numResults, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{query=$query, jurisdiction=$jurisdiction, numResults=$numResults, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "V1FindParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
