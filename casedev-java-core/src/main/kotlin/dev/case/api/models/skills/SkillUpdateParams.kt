...
private constructor(
     ...
     * ```java
     * MyClass myObject = skillUpdateParams.metadata().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): SkillUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(skillUpdateParams: SkillUpdateParams) = apply {
            pathSlug = skillUpdateParams.pathSlug
    ...
    private constructor(
        ...
        ) : this(content, metadata, name, bodySlug, summary, tags, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(content, metadata, name, bodySlug, summary, tags, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{content=$content, metadata=$metadata, name=$name, bodySlug=$bodySlug, summary=$summary, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(pathSlug, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SkillUpdateParams{pathSlug=$pathSlug, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
