...
private constructor(
    ...
    override fun hashCode(): Int =
        Objects.hash(agentId, cursor, limit, status, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "RunListParams{agentId=$agentId, cursor=$cursor, limit=$limit, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
