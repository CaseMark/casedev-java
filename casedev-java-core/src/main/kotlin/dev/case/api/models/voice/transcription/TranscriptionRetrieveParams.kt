...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TranscriptionRetrieveParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [TranscriptionRetrieveParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TranscriptionRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transcriptionRetrieveParams: TranscriptionRetrieveParams) = apply {
            id = transcriptionRetrieveParams.id
            includeText = transcriptionRetrieveParams.includeText
            additionalHeaders = transcriptionRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = transcriptionRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TranscriptionRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TranscriptionRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TranscriptionRetrieveParams &&
            id == other.id &&
    ...
    override fun toString() =
        "TranscriptionRetrieveParams{id=$id, includeText=$includeText, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
