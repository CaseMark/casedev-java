...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): MemoryListParams =
            MemoryListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "MemoryListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
