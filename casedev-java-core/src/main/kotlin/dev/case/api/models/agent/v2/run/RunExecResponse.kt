...
private constructor(
    ...
    ) : this(id, message, provider, runtimeState, status, workflowId, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runExecResponse: RunExecResponse) = apply {
            id = runExecResponse.id
            message = runExecResponse.message
            provider = runExecResponse.provider
            runtimeState = runExecResponse.runtimeState
            status = runExecResponse.status
            workflowId = runExecResponse.workflowId
            additionalProperties = runExecResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): RunExecResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunExecResponse &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, message, provider, runtimeState, status, workflowId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "RunExecResponse{id=$id, message=$message, provider=$provider, runtimeState=$runtimeState, status=$status, workflowId=$workflowId, additionalProperties=$additionalProperties}"
}
