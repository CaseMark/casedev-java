...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitVaultConfirmUploadSuccess(VaultConfirmUploadSuccess vaultConfirmUploadSuccess) {
         *         return Optional.of(vaultConfirmUploadSuccess.toString());
         *     }
         *
         *     // ...
         *
