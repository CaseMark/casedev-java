...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [bundle] with `Bundle.ofReadResponseRoot(readResponseRoot)`. */
        fun bundle(readResponseRoot: ReadResponseRootBundle) =
            bundle(Bundle.ofReadResponseRoot(readResponseRoot))

        /** Alias for calling [bundle] with `Bundle.ofReadResponseFile(readResponseFile)`. */
        fun bundle(readResponseFile: ReadResponseFileBundle) =
            bundle(Bundle.ofReadResponseFile(readResponseFile))
    ...
    class Bundle
    private constructor(
        private val readResponseRoot: ReadResponseRootBundle? = null,
        private val readResponseFile: ReadResponseFileBundle? = null,
        private val _json: JsonValue? = null,
    ) {

        fun readResponseRoot(): Optional<ReadResponseRootBundle> =
            Optional.ofNullable(readResponseRoot)

        fun readResponseFile(): Optional<ReadResponseFileBundle> =
            Optional.ofNullable(readResponseFile)

        fun isReadResponseRoot(): Boolean = readResponseRoot != null

        fun isReadResponseFile(): Boolean = readResponseFile != null

        fun asReadResponseRoot(): ReadResponseRootBundle =
            readResponseRoot.getOrThrow("readResponseRoot")

        fun asReadResponseFile(): ReadResponseFileBundle =
            readResponseFile.getOrThrow("readResponseFile")
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = bundle.accept(new Bundle.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitReadResponseRoot(ReadResponseRootBundle readResponseRoot) {
         *         return Optional.of(readResponseRoot.toString());
         *     }
         *
         *     // ...
         *
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                readResponseRoot != null -> visitor.visitReadResponseRoot(readResponseRoot)
                readResponseFile != null -> visitor.visitReadResponseFile(readResponseFile)
        ...
        fun validate(): Bundle = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitReadResponseRoot(readResponseRoot: ReadResponseRootBundle) {
                        readResponseRoot.validate()
                    }

                    override fun visitReadResponseFile(readResponseFile: ReadResponseFileBundle) {
                        readResponseFile.validate()
                    }
                }
            )
            validated = true
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitReadResponseRoot(readResponseRoot: ReadResponseRootBundle) =
                        readResponseRoot.validity()

                    override fun visitReadResponseFile(readResponseFile: ReadResponseFileBundle) =
                        readResponseFile.validity()
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Bundle &&
                readResponseRoot == other.readResponseRoot &&
                readResponseFile == other.readResponseFile
        }

        override fun hashCode(): Int = Objects.hash(readResponseRoot, readResponseFile)

        override fun toString(): String =
            when {
                readResponseRoot != null -> "Bundle{readResponseRoot=$readResponseRoot}"
                readResponseFile != null -> "Bundle{readResponseFile=$readResponseFile}"
        ...
        companion object {
            ...
            @JvmStatic
            fun ofReadResponseRoot(readResponseRoot: ReadResponseRootBundle) =
                Bundle(readResponseRoot = readResponseRoot)

            @JvmStatic
            fun ofReadResponseFile(readResponseFile: ReadResponseFileBundle) =
                Bundle(readResponseFile = readResponseFile)
        }

        /** An interface that defines how to map each variant of [Bundle] to a value of type [T]. */
        interface Visitor<out T> {

            fun visitReadResponseRoot(readResponseRoot: ReadResponseRootBundle): T

            fun visitReadResponseFile(readResponseFile: ReadResponseFileBundle): T
        ...
        internal class Deserializer : BaseDeserializer<Bundle>(Bundle::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Bundle {
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(node, jacksonTypeRef<ReadResponseRootBundle>())?.let {
                                Bundle(readResponseRoot = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<ReadResponseFileBundle>())?.let {
                                Bundle(readResponseFile = it, _json = json)
                            },
                        )
                        .filterNotNull()
        ...
        internal class Serializer : BaseSerializer<Bundle>(Bundle::class) {
            ...
            override fun serialize(
                ...
                when {
                    value.readResponseRoot != null -> generator.writeObject(value.readResponseRoot)
                    value.readResponseFile != null -> generator.writeObject(value.readResponseFile)
