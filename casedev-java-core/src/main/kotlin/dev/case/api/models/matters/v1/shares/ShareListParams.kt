...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ShareListParams =
            ShareListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ShareListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
