...
/**
 * Updates a vault group for the authenticated organization. Only provided fields are changed, and
 * setting description to null removes the current description.
 */
