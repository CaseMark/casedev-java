...
private constructor(
    ...
    ) : this(agentId, message, provider, runId, runtimeState, status, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(agentId, message, provider, runId, runtimeState, status, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ExecuteCreateResponse{agentId=$agentId, message=$message, provider=$provider, runId=$runId, runtimeState=$runtimeState, status=$status, additionalProperties=$additionalProperties}"
}
