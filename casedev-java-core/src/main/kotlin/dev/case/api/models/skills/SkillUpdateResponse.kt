...
private constructor(
    ...
    ) : this(content, metadata, name, slug, summary, tags, updatedAt, version, mutableMapOf())
     ...
     * ```java
     * MyClass myObject = skillUpdateResponse.metadata().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SkillUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SkillUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skillUpdateResponse: SkillUpdateResponse) = apply {
            content = skillUpdateResponse.content
            metadata = skillUpdateResponse.metadata
            name = skillUpdateResponse.name
            slug = skillUpdateResponse.slug
            summary = skillUpdateResponse.summary
            tags = skillUpdateResponse.tags.map { it.toMutableList() }
            updatedAt = skillUpdateResponse.updatedAt
            version = skillUpdateResponse.version
            additionalProperties = skillUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SkillUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SkillUpdateResponse =
            SkillUpdateResponse(
                content,
                metadata,
                name,
    ...
    fun validate(): SkillUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SkillUpdateResponse &&
    ...
    override fun toString() =
        "SkillUpdateResponse{content=$content, metadata=$metadata, name=$name, slug=$slug, summary=$summary, tags=$tags, updatedAt=$updatedAt, version=$version, additionalProperties=$additionalProperties}"
}
