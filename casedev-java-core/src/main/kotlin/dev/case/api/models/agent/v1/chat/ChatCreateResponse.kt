...
private constructor(
    ...
    ) : this(id, createdAt, idleTimeoutMs, status, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, idleTimeoutMs, status, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ChatCreateResponse{id=$id, createdAt=$createdAt, idleTimeoutMs=$idleTimeoutMs, status=$status, additionalProperties=$additionalProperties}"
}
