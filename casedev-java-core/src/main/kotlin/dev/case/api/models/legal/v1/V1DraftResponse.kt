...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1DraftResponse: V1DraftResponse) = apply {
            agentId = v1DraftResponse.agentId
            message = v1DraftResponse.message
            runId = v1DraftResponse.runId
            status = v1DraftResponse.status
            additionalProperties = v1DraftResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): V1DraftResponse =
            V1DraftResponse(agentId, message, runId, status, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): V1DraftResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V1DraftResponse &&
    ...
    override fun toString() =
        "V1DraftResponse{agentId=$agentId, message=$message, runId=$runId, status=$status, additionalProperties=$additionalProperties}"
}
