...
/**
 * Streams a single assistant turn from a Daytona-backed chat runtime as normalized SSE events with
 * stable turn, message, and part IDs. Emits events: `turn.started`, `turn.status`,
