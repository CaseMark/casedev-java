...
/**
 * Lists files created by the agent in the Daytona runtime workspace. Stopped or archived runtimes
 * are transparently resumed or recovered.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): FileListParams =
            FileListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "FileListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
