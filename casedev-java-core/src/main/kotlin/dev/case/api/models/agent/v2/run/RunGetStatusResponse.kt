...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(runGetStatusResponse: RunGetStatusResponse) = apply {
            ...
            provider = runGetStatusResponse.provider
            runtimeId = runGetStatusResponse.runtimeId
            runtimeState = runGetStatusResponse.runtimeState
        ...
        fun runtimeState(runtimeState: String?) = runtimeState(JsonField.ofNullable(runtimeState))

        /** Alias for calling [Builder.runtimeState] with `runtimeState.orElse(null)`. */
        fun runtimeState(runtimeState: Optional<String>) = runtimeState(runtimeState.getOrNull())
    ...
    override fun toString() =
        "RunGetStatusResponse{id=$id, completedAt=$completedAt, durationMs=$durationMs, provider=$provider, runtimeId=$runtimeId, runtimeState=$runtimeState, startedAt=$startedAt, status=$status, additionalProperties=$additionalProperties}"
}
