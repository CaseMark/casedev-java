...
private constructor(
     ...
     */
    fun archivedAt(): Optional<OffsetDateTime> = body.archivedAt()
     ...
     */
    fun _archivedAt(): JsonField<OffsetDateTime> = body._archivedAt()
    ...
    class Builder internal constructor() {
        ...
        fun archivedAt(archivedAt: OffsetDateTime?) = apply { body.archivedAt(archivedAt) }
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{archivedAt=$archivedAt, billing=$billing, clientName=$clientName, clientPartyId=$clientPartyId, customFields=$customFields, description=$description, displayId=$displayId, importantDates=$importantDates, jurisdiction=$jurisdiction, matterType=$matterType, metadata=$metadata, practiceArea=$practiceArea, responsibleAttorneyId=$responsibleAttorneyId, status=$status, subtype=$subtype, title=$title, additionalProperties=$additionalProperties}"
    }
