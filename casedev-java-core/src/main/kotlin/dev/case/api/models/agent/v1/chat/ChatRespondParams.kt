...
/**
 * Streams a single assistant turn as normalized SSE events with stable turn, message, and part IDs.
 * Emits events: `turn.started`, `turn.status`, `message.created`, `message.part.updated`,
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ChatRespondParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ChatRespondParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ChatRespondParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chatRespondParams: ChatRespondParams) = apply {
            id = chatRespondParams.id
            body = chatRespondParams.body.toBuilder()
            additionalHeaders = chatRespondParams.additionalHeaders.toBuilder()
            additionalQueryParams = chatRespondParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatRespondParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ChatRespondParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
