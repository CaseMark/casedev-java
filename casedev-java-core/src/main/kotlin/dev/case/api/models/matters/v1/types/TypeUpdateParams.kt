...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TypeUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TypeUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TypeUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(typeUpdateParams: TypeUpdateParams) = apply {
            id = typeUpdateParams.id
            body = typeUpdateParams.body.toBuilder()
            additionalHeaders = typeUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = typeUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Alias for calling [Builder.defaultAgentTypeId] with `defaultAgentTypeId.orElse(null)`.
         */
        fun defaultAgentTypeId(defaultAgentTypeId: Optional<String>) =
            defaultAgentTypeId(defaultAgentTypeId.getOrNull())
        ...
        /** Alias for calling [Builder.reviewAgentTypeId] with `reviewAgentTypeId.orElse(null)`. */
        fun reviewAgentTypeId(reviewAgentTypeId: Optional<String>) =
            reviewAgentTypeId(reviewAgentTypeId.getOrNull())
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun defaultAgentTypeId(defaultAgentTypeId: String?) =
                defaultAgentTypeId(JsonField.ofNullable(defaultAgentTypeId))
            ...
            fun reviewAgentTypeId(reviewAgentTypeId: String?) =
                reviewAgentTypeId(JsonField.ofNullable(reviewAgentTypeId))
        ...
        override fun toString() =
            "Body{defaultAgentTypeId=$defaultAgentTypeId, defaultMetadata=$defaultMetadata, defaultWorkItems=$defaultWorkItems, description=$description, exitCriteria=$exitCriteria, instructions=$instructions, intakeRequirements=$intakeRequirements, isActive=$isActive, name=$name, orchestrationMode=$orchestrationMode, reviewAgentTypeId=$reviewAgentTypeId, reviewCriteria=$reviewCriteria, skillRefs=$skillRefs, slug=$slug, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TypeUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "TypeUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
