...
private constructor(
    ...
    /** A builder for [BoostListGenerateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(boostListGenerateResponse: BoostListGenerateResponse) = apply {
            items = boostListGenerateResponse.items.map { it.toMutableList() }
            source = boostListGenerateResponse.source
            sourceIds = boostListGenerateResponse.sourceIds.map { it.toMutableList() }
            additionalProperties = boostListGenerateResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BoostListGenerateResponse =
     ...
     *   expected type.
     */
    fun validate(): BoostListGenerateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    class Source @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val TRANSCRIPT = of("transcript")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BoostListGenerateResponse &&
            items == other.items &&
            source == other.source &&
    ...
    override fun toString() =
        "BoostListGenerateResponse{items=$items, source=$source, sourceIds=$sourceIds, additionalProperties=$additionalProperties}"
}
