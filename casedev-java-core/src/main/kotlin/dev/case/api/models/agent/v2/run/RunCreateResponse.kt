...
private constructor(
    ...
    ) : this(id, agentId, createdAt, objectIds, status, mutableMapOf())
     ...
     */
    @JsonProperty("objectIds") @ExcludeMissing fun _objectIds(): JsonField<List<String>> = objectIds
    ...
    class Builder internal constructor() {
        ...
        internal fun from(runCreateResponse: RunCreateResponse) = apply {
            ...
            objectIds = runCreateResponse.objectIds.map { it.toMutableList() }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, agentId, createdAt, objectIds, status, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "RunCreateResponse{id=$id, agentId=$agentId, createdAt=$createdAt, objectIds=$objectIds, status=$status, additionalProperties=$additionalProperties}"
}
