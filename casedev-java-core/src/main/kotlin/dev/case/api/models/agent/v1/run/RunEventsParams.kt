...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RunEventsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RunEventsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RunEventsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runEventsParams: RunEventsParams) = apply {
            id = runEventsParams.id
            lastEventId = runEventsParams.lastEventId
            additionalHeaders = runEventsParams.additionalHeaders.toBuilder()
            additionalQueryParams = runEventsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RunEventsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RunEventsParams =
            RunEventsParams(
                id,
                lastEventId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunEventsParams &&
            id == other.id &&
    ...
    override fun toString() =
        "RunEventsParams{id=$id, lastEventId=$lastEventId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
