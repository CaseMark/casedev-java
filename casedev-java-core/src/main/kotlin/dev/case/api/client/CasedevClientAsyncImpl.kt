...
import dev.case.api.services.async.DatabaseServiceAsyncImpl
import dev.case.api.services.async.FormatServiceAsync
import dev.case.api.services.async.FormatServiceAsyncImpl
import dev.case.api.services.async.LegalServiceAsync
import dev.case.api.services.async.LegalServiceAsyncImpl
...
import dev.case.api.services.async.SystemServiceAsyncImpl
import dev.case.api.services.async.TranslateServiceAsync
import dev.case.api.services.async.TranslateServiceAsyncImpl
import dev.case.api.services.async.UsageServiceAsync
import dev.case.api.services.async.UsageServiceAsyncImpl
...
class CasedevClientAsyncImpl(private val clientOptions: ClientOptions) : CasedevClientAsync {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val mail: MailServiceAsync.WithRawResponse by lazy {
