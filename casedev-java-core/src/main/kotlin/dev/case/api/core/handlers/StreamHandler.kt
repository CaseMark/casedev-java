...
import dev.case.api.core.http.PhantomReachableClosingStreamResponse
...
/** A sequence that catches, wraps, and rethrows [IOException] as [CasedevIoException]. */
        ...
        return object : Iterator<T> {
            ...
            override fun next(): T =
                try {
                    ...
                    throw CasedevIoException("Stream failed", e)
                }
