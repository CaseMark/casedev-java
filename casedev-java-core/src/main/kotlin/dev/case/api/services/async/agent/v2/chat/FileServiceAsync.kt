...
interface FileServiceAsync {
    ...
    /**
     * Lists files created by the agent in the Daytona runtime workspace. Stopped or archived
    ...
    /**
     * Downloads a file from the Daytona runtime workspace by path. Stopped or archived runtimes are
     * transparently resumed or recovered.
     */
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /agent/v2/chat/{id}/files`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `get /agent/v2/chat/{id}/files/{filePath}`, but is
