...
class ExecuteServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: ExecuteServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): ExecuteServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ExecuteServiceAsync =
        ExecuteServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            ExecuteServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("agent", "v2", "execute")
