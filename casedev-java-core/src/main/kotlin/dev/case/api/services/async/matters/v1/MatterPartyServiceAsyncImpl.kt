...
class MatterPartyServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    MatterPartyServiceAsync {

    private val withRawResponse: MatterPartyServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): MatterPartyServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): MatterPartyServiceAsync =
        MatterPartyServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            MatterPartyServiceAsyncImpl.WithRawResponseImpl(
