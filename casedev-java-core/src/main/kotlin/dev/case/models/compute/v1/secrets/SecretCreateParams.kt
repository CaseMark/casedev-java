...
/**
 * Creates a new secret group in a compute environment. Secret groups organize related secrets for
 * use in serverless functions and workflows. If no environment is specified, the group is created
...
private constructor(
    ...
    /**
     * Unique name for the secret group. Must contain only letters, numbers, hyphens, and
     * underscores.
     *
    ...
    /**
     * Environment name where the secret group will be created. Uses default environment if not
     * specified.
     *
     * @throws CasedevInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    private constructor(
        ...
        ) : this(name, description, env, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            /**
             * Environment name where the secret group will be created. Uses default environment if
             * not specified.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, description, env, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, description=$description, env=$env, additionalProperties=$additionalProperties}"
    }
