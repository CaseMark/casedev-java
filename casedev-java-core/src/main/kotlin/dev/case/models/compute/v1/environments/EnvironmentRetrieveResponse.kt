...
private constructor(
    ...
    /** A builder for [EnvironmentRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(environmentRetrieveResponse: EnvironmentRetrieveResponse) = apply {
            id = environmentRetrieveResponse.id
            createdAt = environmentRetrieveResponse.createdAt
            domain = environmentRetrieveResponse.domain
            isDefault = environmentRetrieveResponse.isDefault
            name = environmentRetrieveResponse.name
            slug = environmentRetrieveResponse.slug
            status = environmentRetrieveResponse.status
            updatedAt = environmentRetrieveResponse.updatedAt
            additionalProperties = environmentRetrieveResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): EnvironmentRetrieveResponse =
    ...
    fun validate(): EnvironmentRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnvironmentRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "EnvironmentRetrieveResponse{id=$id, createdAt=$createdAt, domain=$domain, isDefault=$isDefault, name=$name, slug=$slug, status=$status, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
