...
internal class PartyServiceAsyncTest {
    ...
    fun create() {
        val client =
            CasedevOkHttpClientAsync.builder()
                ...
                .apiKey("My API Key")
                .build()
        val partyServiceAsync = client.payments().v1().parties()
    ...
    fun retrieve() {
        ...
        val future = partyServiceAsync.retrieve("id")
    ...
    fun listPaymentMethods() {
        ...
        val future = partyServiceAsync.listPaymentMethods("id")
