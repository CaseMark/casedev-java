    ...
    fun create() {
        val chatCreateResponse =
            ChatCreateResponse.builder()
                ...
                .idleTimeoutMs(0L)
                .provider(ChatCreateResponse.Provider.DAYTONA)
        ...
        assertThat(chatCreateResponse.provider()).contains(ChatCreateResponse.Provider.DAYTONA)
        assertThat(chatCreateResponse.runtimeState()).contains("runtimeState")
