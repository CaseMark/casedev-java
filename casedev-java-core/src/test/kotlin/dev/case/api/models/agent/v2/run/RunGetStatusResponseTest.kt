...
internal class RunGetStatusResponseTest {
    ...
    fun create() {
        ...
        assertThat(runGetStatusResponse.provider()).contains("provider")
        assertThat(runGetStatusResponse.runtimeId()).contains("runtimeId")
        assertThat(runGetStatusResponse.runtimeState()).contains("runtimeState")
