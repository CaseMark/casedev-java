...
package dev.case.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import dev.case.client.CasedevClientAsync
import dev.case.client.CasedevClientAsyncImpl
import dev.case.core.ClientOptions
import dev.case.core.Sleeper
import dev.case.core.Timeout
...
/**
 * A class that allows building an instance of [CasedevClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class CasedevOkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): CasedevClientAsync = builder().fromEnv().build()
    }
