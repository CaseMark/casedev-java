...
import com.router.api.client.CasedevClientImpl
...
/**
 * A class that allows building an instance of [CasedevClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class CasedevOkHttpClient private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): CasedevClient = builder().fromEnv().build()
    }
