...
dependencies {
    testImplementation(project(":casedev-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../casedev-java-core/src/main/resources/META-INF/proguard/casedev-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.router.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../casedev-java-core/src/main/resources/META-INF/proguard/casedev-java-core.pro",
